...
# --- Configuration ---
TOKEN = '8395709717:AAHnzZTKvqKS9sWSb__mll__87mi-cPrftk' # Replace with your actual token
OWNER_ID = 7725372203 # Replace with your Owner ID
ADMIN_ID = 7725372203 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = 'Mrgta' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'Mrgta' # Replace with your update channel link
